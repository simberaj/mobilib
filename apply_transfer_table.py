...
'''Applies an areal interpolation transfer table to a given field in the table,
...
parser.add_argument('-i', '--id-field', default='id', nargs='+',
...
if __name__ == '__main__':
    ...
    for idcol in args.id_field:
        indf = indf.merge(transdf, left_on=idcol, right_on=trans_source, how='left')
