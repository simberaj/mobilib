'''Transform a CSV (GeoCSV) to a shapefile.'''
...
parser.add_argument('-x', '--x-col', default='X',
    help='name of the x-coordinate attribute in the input file'
)
parser.add_argument('-y', '--y-col', default='Y',
    help='name of the y-coordinate attribute in the input file'
)
...
if __name__ == '__main__':
    ...
    mobilib.write_gdf(mobilib.read_places(args), args.out_file)
